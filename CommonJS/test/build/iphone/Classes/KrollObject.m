...
//@interface CommonJSObject : NSObject
//@end

@interface CommonJSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CommonJSObject class]])
		{
			for (NSString *key in [[(CommonJSObject*)o modules] allKeys])
			{
