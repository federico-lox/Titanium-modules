...
// in simulator we redefine to format for CommonJS Developer console
...
{\
	NSString * exceptionName = [@"org.commonjs." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.commonjs";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UICommonJSNativeItemNone = -1, 
	UICommonJSNativeItemSpinner = -2,
	UICommonJSNativeItemProgressBar = -3,
	
	UICommonJSNativeItemSlider = -4,
	UICommonJSNativeItemSwitch = -5,
	UICommonJSNativeItemMultiButton = -6,
	UICommonJSNativeItemSegmented = -7,
	
	UICommonJSNativeItemTextView = -8,
	UICommonJSNativeItemTextField = -9,
	UICommonJSNativeItemSearchBar = -10,
	
	UICommonJSNativeItemPicker = -11,
	UICommonJSNativeItemDatePicker = -12,
	
	UICommonJSNativeItemInfoLight = -13,
	UICommonJSNativeItemInfoDark = -14,
	
	UICommonJSNativeItemDisclosure = -15,
	
	UICommonJSNativeItemContactAdd = -16
};
